		            ...
		            <table class="table table-striped table-hover table-responsive">
		                ...
		                <tbody>
		                	<?php $no=1; foreach ($dashboard as $key) { ?>
		                        ...
		                        <td>
									<center>
										<a data-toggle="modal" data-target="#modal-edit<?=$key->id_proposal;?>" class="btn btn-info btn-circle" data-popup="tooltip" data-placement="top" title="Edit Status"><i class="fa fa-pencil"></i></a>
									</center>
								</td>
								<td>
									<center>
										<a data-toggle="modal" data-target="#modal-revisi<?=$key->id_proposal;?>" class="btn btn-danger btn-circle" data-popup="tooltip" data-placement="top" title="Revisi"><i class="fa fa-edit"></i></a>
									</center>
								</td>
		                    </tr>
		                	<?php $no++; }  ?>
