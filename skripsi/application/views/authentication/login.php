<div class="login-box">
	<div class="login-logo">
		<h2 style="font-family: Verdana"> MONTA IF </h2>
	</div>
	<!-- /.login-logo -->
	<div class="login-box-body">
		<h3 class="login-box-msg text-bold"> Login </h3>
		<form method="post" action="<?php echo base_url('auth/login'); ?>" role="login">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-6" style="padding-bottom: 5px">
					<button type="submit" name="submit" value="login" class="btn btn-dark btn-block btn-flat"><i class="fa fa-sign-in" aria-hidden="true"></i> Masuk</button>
				</div>
			</div>
			<a href="<?php echo base_url('auth/forgot_password'); ?>"> Forgot Password?</a><br>
