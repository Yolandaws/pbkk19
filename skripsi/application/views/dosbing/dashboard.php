...
<div class="container">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						            <h2 style="color: #fff; font-size: 14px">Judul Tugas Akhir</b></h2>
					         </div>
                </div>
            </div>
            <table id="dataTable" class="table table-striped table-hover table-responsive">
                <thead>
                    <tr>
                      ...
                      <th><center>Tambah Revisi</center></th>
                    </tr>
                </thead>
                <tbody>
                	...
                	<tr>
                        ...
                        <td> <CENTER>
                          ...
                          ?> </CENTER>
            						...
            						<td>
            									<center>
            										<a data-toggle="modal" data-target="#modal-edit<?=$key->id_proposal;?>" class="btn btn-danger btn-circle" data-popup="tooltip" data-placement="top" title="Edit Status"><i class="fa fa-pencil"></i></a>
            									</center>
								        </td>
        								<td>
        									<center>
        										<a data-toggle="modal" data-target="#modal-revisi<?=$key->id_proposal;?>" class="btn btn-info btn-circle" data-popup="tooltip" data-placement="top" title="Revisi"><i class="fa fa-edit"></i></a>
        									</center>
        								</td>
		              </tr> 
		              <?php $no++; }  ?>   
