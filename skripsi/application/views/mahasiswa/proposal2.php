...
<div class="container">
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body" >
                <?php echo form_open('mahasiswa/home/proposal'); ?>
                    <!-- <form  class="form-horizontal" method="post" > -->
                       <div id="div_id_username" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input type="text" name="nama_mhs" class="input-md emailinput form-control" value="<?php echo $datalogin->last_name; ?>" style="margin-bottom: 10px" readonly autofocus>
                            </div>
                        </div>
                          ...
                          <div id="div_id_email" class="form-group required">
                            ...
                            <div class="controls col-md-8 " style="margin-bottom: 10px">
                                <select name="pembimbing2" class="form-control" required="">
                                  ...
                                  <?php  foreach ($dosen as $value) : ?>
                                  <option value="<?php echo $value['nama_dosen']."+".$value['nip']; ?>"><?php echo "--  "  .$value['nama_dosen'];
                                      ?></option>
                                  <?php endforeach; ?>
                                </select>
                            </div>    
