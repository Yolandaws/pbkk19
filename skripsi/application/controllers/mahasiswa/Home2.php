...
class Home extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('layout/templatemhs', 'mahasiswa/dashboard', $data);
    }
    ...
    public function judul()
    {
        ...
        if ($this->input->post('submit')) {
               ...
               if ($query) {
                   ...
                   redirect(base_url('mahasiswa/home/judul'));
               }
   
           }
           else
           {
              $this->template->load('layout/templatemhs', 'mahasiswa/judul', $data);
            }
    }
    ...
    public function proposal()
    {
        ...
        if ($this->input->post('submit')) {
               ...
               if ($query) {
                   $this->session->set_flashdata('berhasil_simpan', 'sukses');
                   redirect(base_url('mahasiswa/home/proposal'));
               }
   
           }
           else
           {
            $this->template->load('layout/templatemhs', 'mahasiswa/proposal', $data);
           }
    }
    ...
    public function status()
    {
        ...
        $this->template->load('layout/templatemhs', 'mahasiswa/status', $data);
    }

    public function tabelta()
    {
        $site = $this->Konfigurasi_model->listing();
        $data = array(
            'title'     => 'Dashboard | MONTA',
        ...
        $this->template->load('layout/templatemhs', 'mahasiswa/tabelta', $data);
    }
    ...
    public function status_sidang()
    {
        ...
        $data = array(
            ...
            'favicon'   => $site['favicon'],
            'site'      => $site,
            'dashboard' => $this->Mhs_dashboard->status_sidang($NRP)
        );
        $this->template->load('layout/templatemhs', 'mahasiswa/status_sid', $data);
    }
